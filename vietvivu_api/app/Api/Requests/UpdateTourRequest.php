...
class UpdateTourRequest extends BaseRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            // ========== TOUR ==========
            'title' => 'required|string|max:255|unique:tours,title,' . $id . ',id,deleted_at,NULL',
            'description' => 'nullable|string',

            'slug' => 'nullable|string|max:255|unique:tours,slug,' . $id . ',id,deleted_at,NULL',
            'code' => 'nullable|string|max:100|unique:tours,code,' . $id . ',id,deleted_at,NULL',
            ...
            'images.*.id' => 'nullable|integer|exists:tour_images,id',
            'images.*._delete' => 'nullable|boolean',

            // chỉ validate nếu có file upload
            'images.*.file' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:51200',
    ...
    public function messages()
    {
        return [
            ...
            'images.*.id.integer' => 'ID ảnh phải là số nguyên.',
            'images.*.id.exists' => 'Ảnh bạn chọn không tồn tại.',
            'images.*._delete.boolean' => 'Giá trị xoá ảnh phải là true hoặc false.',
            'images.*.file.image' => 'File tải lên phải là hình ảnh.',
            'images.*.file.mimes' => 'Ảnh phải có định dạng: jpg, jpeg, png hoặc webp.',
            'images.*.file.max' => 'Kích thước ảnh tối đa là 4MB.',
